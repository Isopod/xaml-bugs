...
init_island(struct MyWindow *window)
{
    ...
    markup = 
        ...
        L"      Background='{ThemeResource SystemControlChromeHighAcrylicWindowMediumBrush}'>"
        L"  <Button Content='Click me' x:Name='button' HorizontalAlignment='Center' VerticalAlignment='Center' /> "
        L"</Grid>";
...
WindowProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    ...
    switch (msg)
    {
        ...
        case WM_DESTROY: {
            window->island_root->lpVtbl->Release(window->island_root);
